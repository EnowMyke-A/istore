...
const SearchComponent = ({addClass,passedHeroSection}) => {
  ...
  useEffect(() => {
	...
	return (
		<div className={`${addClass?"reveal-search main-search-container":"main-search-container"} ${passedHeroSection?"light":""}`}>
			<div className="search-tools">
				<form action="" className={addClass?"search-focus":""}>
					<input ref={searchInput} type="text" id="searchInput" placeholder="Search"/>
					<svg
